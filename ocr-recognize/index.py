...
SERVICE_VERSION = "ocr-recognize-2026-07-03-v6"
...
def handler(event, context):
    ...
    try:
        ...
        if fields and all(value == "" for value in cleaned_result.values()):
            return _response(422, {"success": False, "error": "未能识别出有效字段，请更换清晰图片后重试"})
