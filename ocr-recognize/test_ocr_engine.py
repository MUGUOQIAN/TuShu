...
class OcrEngineTest(unittest.TestCase):
    ...
    def test_extract_text_chunks_reads_string_md_results_and_nested_layout(self):
        ...
        self.assertIn("发票号码 123456", chunks)
        self.assertIn("价税合计金额 100.00", chunks)
    ...
    def test_direct_business_fields_do_not_trigger_second_request(self):
        payload = {"data": {"发票号码": "123456", "价税合计金额": "100.00"}}
